...
<body>
    ...
    <main>
        <h1>Welcome to Ed's Electronics Computer page </h1>
        ...
        <h2>Sample form</h2>
        <form action="home final page computer .php" method="post">
...
<?php
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if(isset($_POST["name"]) && isset($_POST["subject"]) && isset($_POST["email"]) && isset($_POST["enquiry"])) {
                // Process form data
                $name = $_POST["name"];
